...
int main()
{
    ...
    readKeypoints("../dat/C35A5_KptsSource_SIFT.dat", kptsSource); //C35A5_KptsSource_SIFT.dat, C35A5_KptsSource_BRISK_small.dat
    readKeypoints("../dat/C35A5_KptsRef_SIFT.dat", kptsRef); //C35A5_KptsRef_SIFT.dat, C35A5_KptsRef_BRISK_small.dat

    cv::Mat descSource, descRef; 
    readDescriptors("../dat/C35A5_DescSource_SIFT.dat", descSource); //C35A5_DescSource_SIFT.dat, C35A5_DescSource_BRISK_small.dat
    readDescriptors("../dat/C35A5_DescRef_SIFT.dat", descRef); //C35A5_DescRef_SIFT.dat, C35A5_DescRef_BRISK_small.dat
